  ...
  Widget build(BuildContext context) {
    ...
    return Column(
      children: [
        ...
        Expanded(
          child: overview ? const _AdminOverview() : _AdminPlaceholder(section: section),
        ),
      ],
    );
  }
  ...
  Widget build(BuildContext context) {
    ...
    return ListView(
      ...
      children: [
        ...
        Card(
          child: ListTile(
            leading: const Icon(Icons.info_outline, color: AurenzaColors.gold),
            title: const Text('Foundation status'),
            subtitle: const Text('Admin shell, responsive navigation, role gate, module registry, and safe placeholder states are ready. No client-side action can mutate money or trading state.'),
          ),
        ),
      ],
    );
